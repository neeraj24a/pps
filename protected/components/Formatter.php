...
class Formatter extends CFormatter
{
    ...
    */
    ...
    public function formatNumberEx($value,$decimals=null,$decimalSeparator=null,$thousandSeparator=null) {
        if($decimals===null) $decimals=$this->numberFormat['decimals'];
        if($decimalSeparator===null) $decimalSeparator=$this->numberFormat['decimalSeparator'];        
        if($thousandSeparator===null) $thousandSeparator=$this->numberFormat['thousandSeparator'];        
        if($value === null) return null;    // new
        if($value === '') return '';        // new
